...
export const TARGETS: TargetMeta[] = [
  // Tメール（Gmail仕分けレイヤー）。Next.js16+Prisma7+next-auth v5、Railway本番稼働中。
  // Gmail本文・refresh_tokenを扱うためPII_HEAVY_FORBIDDEN。
  { system: "Tメール", repo: "tkgathr2/tmail", healthUrl: "https://tmail-web-production.up.railway.app/api/health", forbiddenPaths: PII_HEAVY_FORBIDDEN, autoEligible: true },
